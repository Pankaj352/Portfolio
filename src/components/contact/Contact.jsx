...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_ovc40f8', 'template_iqd5pql', form.current, 'GQFG1NMCONcRIrXgJ')
        .then((result) => {
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">8948291922</span>
          ...
          <form ref={form} onSubmit={sendEmail} action="" className="contact__form">
            <div className="contact__form-div">
              ...
              <input
                ...
                id="" className="contact__form-input"
              />
            </div>
            <div className="contact__form-div">
              <label htmlFor="" className="contact__form-tag">
